...
(function(){
  ...
  var btn=document.createElement('button');btn.id='_cw_btn';btn.innerHTML='<img src="/logo.png" style="width:34px;height:34px;object-fit:contain;" />';document.body.appendChild(btn);
  var box=document.createElement('div');box.id='_cw_box';
  box.innerHTML='<div id="_cw_hd"><span><img src="/logo.png" style="width:22px;height:22px;object-fit:contain;margin-right:8px;vertical-align:middle;"/>'+N+'</span><button id="_cw_cls">&#x2715;</button></div><div id="_cw_msgs"></div><div id="_cw_inp"><input id="_cw_in" placeholder="Digite uma mensagem..." type="text"/><button id="_cw_snd">&#10148;</button></div>';
