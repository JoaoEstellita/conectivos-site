...
const products = [
  ...
  {
    tab: "Social Monitor",
    name: "Social Monitor — Inteligência de Presença Digital",
    color: "#6366f1",
    screenshot: "/screenshots/social-monitor.png",
    tag: "SaaS · Reputação de Marca",
    pageUrl: "/servicos/monitor",
    headline: "Monitoramento + score de reputação por IA",
    description:
      "Plataforma SaaS que monitora menções em YouTube, Instagram e Twitter/X em tempo real, detecta crises automaticamente, analisa concorrentes e gera relatórios executivos com IA.",
    features: [
      { icon: "📡", label: "Feed de menções em tempo real", detail: "YouTube, Instagram e Twitter/X por keywords, hashtags e handles" },
      { icon: "🧠", label: "Análise de sentimento por IA", detail: "Claude Haiku classifica positivo / negativo / neutro em batch de 50" },
      { icon: "🏆", label: "Score de reputação 0–100", detail: "Calculado diariamente com histórico e tendência visual" },
      { icon: "🚨", label: "Detecção automática de crises", detail: "Alerta em 10min quando volume supera 2σ ou negatividade > 60%" },
      { icon: "⚔️", label: "Análise de concorrentes", detail: "Share of voice e benchmark de sentimento side-by-side" },
      { icon: "🎯", label: "Radar de influenciadores", detail: "Identifica quem fala da marca com tier micro / médio / macro" },
      { icon: "📈", label: "Correlação Meta Ads", detail: "Cruza buzz orgânico × investimento para medir impacto de campanhas" },
      { icon: "📄", label: "Relatórios executivos por IA", detail: "Claude Sonnet gera relatórios semanais prontos para boardroom" },
      { icon: "🔔", label: "Alertas WhatsApp + email", detail: "Notificações instantâneas de crises e picos de menções" },
      { icon: "🎨", label: "White-label completo", detail: "Logo, cor primária e nome personalizados por conta" },
    ],
  },
];
