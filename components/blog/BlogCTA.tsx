const WHATSAPP_URL =
  "https://wa.me/5521999953224?text=Olá,%20li%20um%20artigo%20da%20Conectivos%20e%20gostaria%20de%20saber%20mais.";

export function BlogCTA() {
  return (
    <div
      className="my-10 p-6 rounded-2xl text-center"
      style={{
    ...
    >
      ...
      <p className="text-sm mb-5" style={{ color: "#64748B" }}>
        Blueprint de automação personalizado + mapeamento de ROI — sem compromisso.
      </p>
      <a
        href={WHATSAPP_URL}
        target="_blank"
